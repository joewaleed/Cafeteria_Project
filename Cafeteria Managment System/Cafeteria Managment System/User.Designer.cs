namespace Cafeteria_Managment_System
{
    partial class User
    {
        ...
        private void InitializeComponent() {
            ...
            // panel3
            // 
            panel3.BackColor = Color.FromArgb(65, 72, 51);
            ...
            UsersDG.ThemeStyle.AlternatingRowsStyle.Font = null;
            UsersDG.ThemeStyle.AlternatingRowsStyle.ForeColor = Color.Empty;
            UsersDG.ThemeStyle.AlternatingRowsStyle.SelectionBackColor = Color.Empty;
            UsersDG.ThemeStyle.AlternatingRowsStyle.SelectionForeColor = Color.Empty;
            UsersDG.ThemeStyle.BackColor = Color.FromArgb(88, 47, 14);
            UsersDG.ThemeStyle.GridColor = Color.FromArgb(222, 201, 231);
            UsersDG.ThemeStyle.HeaderStyle.BackColor = Color.FromArgb(155, 89, 182);
            UsersDG.ThemeStyle.HeaderStyle.BorderStyle = DataGridViewHeaderBorderStyle.None;
            UsersDG.ThemeStyle.HeaderStyle.Font = new Font("Poppins", 12F, FontStyle.Bold, GraphicsUnit.Point, 0);
            UsersDG.ThemeStyle.HeaderStyle.ForeColor = Color.White;
            UsersDG.ThemeStyle.HeaderStyle.HeaightSizeMode = DataGridViewColumnHeadersHeightSizeMode.EnableResizing;
            UsersDG.ThemeStyle.HeaderStyle.Height = 35;
            UsersDG.ThemeStyle.ReadOnly = true;
            UsersDG.ThemeStyle.RowsStyle.BackColor = Color.FromArgb(235, 221, 240);
            UsersDG.ThemeStyle.RowsStyle.BorderStyle = DataGridViewCellBorderStyle.SingleHorizontal;
            UsersDG.ThemeStyle.RowsStyle.Font = new Font("Poppins", 12F, FontStyle.Bold, GraphicsUnit.Point, 0);
            UsersDG.ThemeStyle.RowsStyle.ForeColor = Color.Black;
